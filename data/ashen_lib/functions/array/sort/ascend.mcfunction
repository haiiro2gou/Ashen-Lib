...
# ソートを実行
    ...
    execute unless data storage ashen_lib:temp Array.Asc[-1] run function ashen_lib:array/core/sort/ascend/
    data modify storage ashen_lib:api Array set from storage ashen_lib:temp Array.Asc[-1]
# リセット
